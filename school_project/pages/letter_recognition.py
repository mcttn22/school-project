...
from school_project.models.image_recognition.letter import PerceptronModel

class LetterRecognitionFrame(tk.Frame):
    """Frame for Letter Recognition page."""
    def __init__(self, root: tk.Tk, width: int, height: int) -> None:
        """Initialise letter recognition frame widgets.
        ...
        self.about_label: tk.Label = tk.Label(
                                     ...
                                     "recognising Letters from images."
                                    )
        self.cat_recognition_theory_button: tk.Button = tk.Button(
                                          ...
                                          text="View Letter Recognition Theory")
