...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Using function 3, $\frac{\partial{L}}{\partial{A}} = \frac{Y-A}{A * (1-A)}$
        \item Using function 2, $\frac{\partial{A}}{\partial{Z}} = A * (1-A)$
        \item Using function 1, $\frac{\partial{Z}}{\partial{W}} = X$
        \item => $\frac{\partial{L}}{\partial{W}} = \frac{Y-A}{A * (1-A)} * A * (1-A) * X\\
              = X * (A-Y)$
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Derived above, $\frac{\partial{L}}{\partial{A}} = \frac{Y-A}{A * (1-A)}$
        \item Derived above, $\frac{\partial{A}}{\partial{Z}} = A * (1-A)$
        \item Using function 1, $\frac{\partial{Z}}{\partial{B}} = 1$
        \item => $\frac{\partial{L}}{\partial{W}} = \frac{Y-A}{A * (1-A)} * A * (1-A)\\
              = A-Y$
    \end{itemize}
\end{itemize}
