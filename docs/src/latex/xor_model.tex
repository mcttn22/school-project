...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Using function 5, $\frac{\partial{L}}{\partial{A2}} = \frac{Y-A2}{A2 * (1-A2)}$
        \item Using function 4, $\frac{\partial{A2}}{\partial{Z2}} = A2 * (1-A2)$
        \item Using function 3, $\frac{\partial{Z2}}{\partial{W2}} = A1$
        \item => $\frac{\partial{L}}{\partial{W2}} = \frac{Y-A2}{A2 * (1-A2)} * A2 * (1-A2) * A1\\
              = (A2-Y) * A1$
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item => $\frac{\partial{L}}{\partial{B2}} = \frac{Y-A2}{A2 * (1-A2)} * A2 * (1-A2)\\
              = A2-Y$
    \end{itemize}
