...
\includepdf[pages=-]{./project-report/src/pdfs/learning-rate-analysis.pdf}
\includepdf[pages=-]{./project-report/src/pdfs/epoch-count-analysis.pdf}
\includepdf[pages=-]{./project-report/src/pdfs/train-dataset-size-analysis.pdf}
\includepdf[pages=-]{./project-report/src/pdfs/layer-count-analysis.pdf}
\includepdf[pages=-]{./project-report/src/pdfs/neuron-count-analysis.pdf}
\includepdf[pages=-]{./project-report/src/pdfs/relu-analysis.pdf}
\includepdf[pages=-]{./project-report/src/pdfs/cpu-vs-gpu-analysis.pdf}
