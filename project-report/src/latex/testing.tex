    ...
    \item Unit tests for the database in a test\_database.py module:
        \begin{itemize}
            ...
            \item Evidence:
				...
				\begin{figure}[h!]
				\centering
				\frame{\includegraphics[width=1\textwidth]{./project-report/src/images/test-database.png}}
				\end{figure}
            ...
            \item test\_model.py module:
				\begin{itemize}
					...
					\item Evidence:
						...
						\begin{figure}[h!]
						\centering
						\frame{\includegraphics[width=1\textwidth]{./project-report/src/images/test-model.png}}
						\end{figure}
            ...
            \item test\_tools.py module:
				\begin{itemize}
					...
					\item Evidence:
						...
						\begin{figure}[h!]
						\centering
						\frame{\includegraphics[width=1\textwidth]{./project-report/src/images/test-tools.png}}
						\end{figure}
