...
\begin{tabular}{|p{0.03\linewidth}|p{0.73\linewidth}|p{0.12\linewidth}|p{0.12\linewidth}|}
      ...
      \hline
      2.2 & Allow for the saving of trained models' weights and biases & \hyperref[sec:model-module]{Page \pageref{sec:model-module}} & \hyperref[sec:unit-tests]{Page \pageref{sec:unit-tests}} \\
      \hline
